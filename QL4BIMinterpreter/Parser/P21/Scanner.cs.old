...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 35; i <= 35; ++i) start[i] = 3;
		for (int i = 48; i <= 57; ++i) start[i] = 16;
		for (int i = 65; i <= 90; ++i) start[i] = 11;
		for (int i = 97; i <= 122; ++i) start[i] = 11;
		for (int i = 59; i <= 59; ++i) start[i] = 13;
		start[39] = 1; 
		start[61] = 5; 
		start[40] = 22; 
		start[41] = 6; 
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 1:
				if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '&' || ch >= '(' && ch <= ':' || ch >= '<' && ch <= 65535) {AddCh(); goto case 1;}
			...
			case 13:
				...
				else if (ch == 13) {AddCh(); goto case 14;}
				else {goto case 0;}
			case 14:
				if (ch == 10) {AddCh(); goto case 15;}
				else {goto case 0;}
			case 15:
				{t.kind = 10; break;}
			case 16:
