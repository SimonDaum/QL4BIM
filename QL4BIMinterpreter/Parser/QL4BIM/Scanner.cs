...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 43; i <= 43; ++i) start[i] = 14;
		for (int i = 45; i <= 45; ++i) start[i] = 15;
	...
	void CheckLiteral() {
		switch (t.val) {
			case "true": t.kind = 16; break;
			case "false": t.kind = 17; break;
			case "unknown": t.kind = 18; break;
			case "is": t.kind = 25; break;
			case "func": t.kind = 26; break;
			default: break;
		}
	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 2:
				...
				else if (ch == '+' || ch == '-') {AddCh(); goto case 3;}
				else {goto case 0;}
			case 3:
				if (ch >= '0' && ch <= '9') {AddCh(); goto case 4;}
				else {goto case 0;}
			...
			case 7:
				if (ch >= '-' && ch <= '.' || ch >= '0' && ch <= ':' || ch >= 'A' && ch <= 'Z' || ch == 92 || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 7;}
				else if (ch == '"') {AddCh(); goto case 8;}
				else {goto case 0;}
			case 8:
				{t.kind = 5; break;}
			case 9:
				if (ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 10;}
				else {goto case 0;}
			case 10:
			...
			case 11:
				...
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 12;}
				else {t.kind = 7; break;}
			case 12:
				{t.kind = 7; break;}
			case 13:
